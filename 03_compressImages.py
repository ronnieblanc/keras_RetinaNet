...
def single_imageCompress(old_jpgFilePath, new_jpgFilePath, new_size):
...
def batch_imageCompress(old_dirPath, new_dirPath, new_size, suffix):
    ...
    jpgFilePath_list = getFilePathList(old_dirPath, suffix)
    for jpgFilePath in jpgFilePath_list:
        old_jpgFilePath = jpgFilePath
        jpgFileName = os.path.split(old_jpgFilePath)[1]
        new_jpgFilePath = os.path.join(new_dirPath, jpgFileName)
        single_imageCompress(old_jpgFilePath, new_jpgFilePath, new_size)
